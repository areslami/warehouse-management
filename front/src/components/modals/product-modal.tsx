...
export function ProductModal({ trigger, onSubmit, onClose, initialData }: ProductModalProps) {
  const tval = useTranslations("modals.product.validation");
  const t = useTranslations("modals.product");
  ...
  const productSchema = z.object({
    ...
    b2bregion: z.string().min(1, tval("b2bregion")),
    category: z.string().min(1, tval("category")),
  ...
  const form = useForm<ProductFormData>({
    ...
    defaultValues: {
      ...
      b2bregion: initialData?.b2bregion || "",
