...
class WarehouseReceipt(models.Model):
    ...
    receipt_id = models.CharField(max_length=50, unique=True,null=True)
    ...
    cottage_serial_number = models.CharField(max_length=100, null=True, blank=True)
...
class DispatchIssueItem(models.Model):
    ...
    receiver = models.ForeignKey('core.Receiver', on_delete=models.SET_DEFAULT)
